...
contract LayerZeroDebugTest is Test {
    ...
    address constant LZ_CALLER = 0xF5E8A439C599205C1aB06b535DE46681Aed1007a;
    ...
    // raw calldata
    bytes constant RAW_CALL_DATA = hex"";
    ...
    function testLayerZeroTransaction() public {
        ...
        // simulate la executor raw tx
        vm.startPrank(LZ_CALLER);
        (bool success, bytes memory result) = LZ_EXECUTOR.call{gas: 803604}(RAW_CALL_DATA);
        if (success) {
            console.log("Full tx success");
        } else {
            console.log("Full tx failed");
        }
    }
